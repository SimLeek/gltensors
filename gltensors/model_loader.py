# permanently borrowed from wavefront_reader: https://github.com/ratcave/wavefront_reader/blob/master/wavefront_reader/reading.py
# I'll be modifying this
        ...
        if line:
            ...
            if 'newmtl' in prefix:
                ...
                if data:
                    ...
                    if data.replace('.', '').replace(' ', '').replace('e', '').isdigit():
                        if len(split_data) > 1:
